...
describe('Unit', () => {
  ...
  it('renders correctly', () => {
    ...
    expect(renderedUnit).toHaveAttribute(
      'src', `http://student.launchpadlearning.ca/xblock/${mockData.id}?show_title=0&show_bookmark_button=0&recheck_access=1&view=student_view&format=${mockData.format}`,
    );
  });
